var connectService = 'http://localhost:8001/warberry/WarberryReporting/SQLiteConnection/home.php';
$.ajax({
    type: "GET",
    url: connectService,
    ...
    success: function(result){
        ...
        if (response.status.indexOf("success")>=0) {
            ...
            convertedLastSession=convert(dt);
            document.getElementById("datetime").innerHTML = convertedLastSession; // dt.toLocaleString()
        }
        else{
