var siteUrl = 'http://localhost:8001/warberry/';
var connectService = siteUrl+'WarberryReporting/SQLiteConnection/reporting.php';
...
function findSession(){
    ...
    //var sessionService= 'http://localhost:8001/warberry/WarberryReporting/SQLiteConnection/session.php';
    var sessionService= siteUrl+'WarberryReporting/SQLiteConnection/session.php';
    if (sessionID==null){
        $.ajax({
            type: "GET",
            url: sessionService,
...
function showInfo(ipg) {
    //var connect="http://localhost:8001/warberry/WarberryReporting/SQLiteConnection/ip.php";
    var connect= siteUrl+'WarberryReporting/SQLiteConnection/ip.php';
...
function showIPS(serv) {
    //var connect="http://localhost:8001/warberry/WarberryReporting/SQLiteConnection/service.php";
    var connect= siteUrl+'WarberryReporting/SQLiteConnection/service.php';
    var s=localStorage.getItem("session");
...
function showSessionReporting(sessionID){
    ...
    //var connectService = 'http://localhost:8001/warberry/WarberryReporting/SQLiteConnection/reporting.php';
    var connectService= siteUrl+'WarberryReporting/SQLiteConnection/reporting.php';
    var sessionID=findSession();
    if (sessionID==-1){
        console.log("No sessions found");
