...
def shares_enum(iface, hosts):
        ...
        for host in hosts:
            ...
            with open("Results/shares.xml", "wb") as xmlfile:
...
def smb_users(iface, hosts):
        ...
        for host in hosts:
            ...
            result = nm.get_nmap_last_output()
            with open("Results/smb_users.xml", "wb") as xmlfile:
                xmlfile.write(result)
                xmlfile.close()
...
def nfs_enum(iface, shares):
        ...
        for share in shares:
            ...
            result = nm.get_nmap_last_output()
            with open("Results/nfs_enum.xml", "wb") as xmlfile:
                xmlfile.write(result)
                xmlfile.close()
...
def mysql_enum(iface, dbs):
    ...
    for db in dbs:
        ...
        result = nm.get_nmap_last_output()
        with open("Results/mysql_enum.xml", "wb") as xmlfile:
            xmlfile.write(result)
            xmlfile.close()
...
def mssql_enum(iface,dbs):
    ...
    for db in dbs:
        ...
        result = nm.get_nmap_last_output()
        with open("Results/mssql_enum.xml", "wb") as xmlfile:
            xmlfile.write(result)
            xmlfile.close()
...
def ftp_enum(iface,ftps):
    ...
    for ftp in ftps:
        ...
        result = nm.get_nmap_last_output()
        with open("Results/ftp_enum.xml", "wb") as xmlfile:
            xmlfile.write(result)
            xmlfile.close()
...
def snmp_enum(iface,snmps):
    ...
    for snmp in snmps:
        ...
        result = nm.get_nmap_last_output()
        with open("Results/snmp_enum.xml", "wb") as xmlfile:
            xmlfile.write(result)
            xmlfile.close()
...
def sip_methods_enum(iface,sips):
    ...
    for sip in sips:
        ...
        result = nm.get_nmap_last_output()
        with open("Results/sip_methods.xml", "wb") as xmlfile:
            xmlfile.write(result)
            xmlfile.close()
...
def sip_users_enum(iface,sips):
    ...
    for sip in sips:
        ...
        result = nm.get_nmap_last_output()
        with open("Results/sip_users.xml", "wb") as xmlfile:
            xmlfile.write(result)
            xmlfile.close()
